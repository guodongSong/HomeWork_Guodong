...
GLuint HCoreLoadDDSTexture_OpenGL(const char *filename, sImageInfo *pInfo)
{
...
GLuint HCoreLoadCompressedCubemapTexture_OpenGL(const char **filename_array)
{
...
GLuint HCoreLoadNoCompressedTexture_OpenGL(const char *filename, sImageInfo *pInfo, bool mipmap_enabled)
{
	GLuint textureID;
	glGenTextures( 1, &textureID );
	glBindTexture( GL_TEXTURE_2D, textureID );
...
GLuint HCoreLoadNoCompressedCubemapTexture_OpenGL(const char **filename_array, bool mipmap_enabled)
{
	GLuint textureID;
...
GLuint HCoreLoadTexture_OpenGL(const char *filename, sImageInfo *pInfo, bool mipmap_enabled = true)
{
	char file_ext[16];
	_splitpath(filename, NULL, NULL, NULL, file_ext);
	strlwr(file_ext);
	...
	{
		return HCoreLoadDDSTexture_OpenGL(filename, pInfo);
	}
	else if ( !strcmp(file_ext, ".tga") )
	{
		return HCoreLoadNoCompressedTexture_OpenGL(filename, pInfo, mipmap_enabled);
	}
	else if ( !strcmp(file_ext, ".bmp") )
	{
		return HCoreLoadNoCompressedTexture_OpenGL(filename, pInfo, mipmap_enabled);
...
GLuint HCoreLoadCubemapTexture_OpenGL(const char **filename_array, bool mipmap_enabled = true)
{
	...
	if ( !strcmp(file_ext, ".dds") )
	{
		return HCoreLoadCompressedCubemapTexture_OpenGL(filename_array);
	}
	else if ( !strcmp(file_ext, ".tga") )
	{
		return HCoreLoadNoCompressedCubemapTexture_OpenGL(filename_array, mipmap_enabled);
	}
	else if ( !strcmp(file_ext, ".bmp") )
	{
		return HCoreLoadNoCompressedCubemapTexture_OpenGL(filename_array, mipmap_enabled);
