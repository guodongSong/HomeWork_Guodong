...
char *CHCoreModel::m_pszTexturePath = NULL;
...
CHCoreModel::~CHCoreModel()
{
	Release();
}

void CHCoreModel::Release(void)
{
	if ( m_pMaterialArray )
	{
...
bool CHCoreModel::LoadMaterial_ASCII(void)
{
	char szBuffer[128];
	char szTag[64];
	char szContent[64];
...
bool CHCoreModel::LoadMesh_ASCII(void)
{
	char szBuffer[128];
	char sz_Tag[64];
...
bool CHCoreModel::Load_ASCII(const char *filename)
{
...
bool CHCoreModel::LoadMaterial_BINARY(void)
{
	return true;
}

bool CHCoreModel::LoadMesh_BINARY(void)
{
	return true;
}

bool CHCoreModel::Load_BINARY(const char *filename)
{
	return false;
}
...
void CHCoreModel::SetTexturePath(const char *path)
{
	if ( m_pszTexturePath )
	{
...
const sVertexDecl *CHCoreModel::GetVertexFormat(void)
{
...
bool CHCoreModel::CreateSphere(float radius, sVertexDecl *pVertexDecl, int stacks, int slices)
{
	Release();
